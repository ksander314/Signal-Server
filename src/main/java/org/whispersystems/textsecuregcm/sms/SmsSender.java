...
public class SmsSender {
  ...
  static final String SMS_IOS_VERIFICATION_TEXT        = "Your Flash verification code: %s\n\nOr tap: sgnl://verify/%s";
  static final String SMS_ANDROID_NG_VERIFICATION_TEXT = "<#> Your Flash verification code: %s\n\ndoDiFGKPO1r";
  static final String SMS_VERIFICATION_TEXT            = "Your Flash verification code: %s";
